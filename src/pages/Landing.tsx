      ...
      <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12 h-full flex flex-col relative z-10">
        ...
        <main ref={containerRef} className="flex flex-col lg:flex-row items-center justify-between mt-8 sm:mt-12 lg:mt-20 gap-8 sm:gap-12 flex-grow">
          ...
          y: 20
            ...
            <motion.h1 className="text-3xl sm:text-5xl lg:text-6xl font-bold leading-tight mb-4 sm:mb-6" initial={{
            opacity: 0,
            y: 20
          }} animate={controls}>
            ...
            <motion.h2 className="text-xl sm:text-2xl text-gray-300 mb-6 sm:mb-8" initial={{
            opacity: 0,
            y: 20
            ...
            delay: 0.2
              ...
              <p className="text-base sm:text-lg text-gray-200 max-w-xl mx-auto lg:mx-0 relative z-10">UNIVERSAL.AI IS FOR THE CREATOR, PERPETUAL CREATOR CRYPTO MACHINES, HYPERLIQUID CULTURE FUND</p>
            </motion.div>
            ...
            scale: 0.98
              ...
              <Button onClick={() => navigate("/wzrd/studio")} className="text-sm sm:text-base bg-transparent hover:bg-white/10 border border-white/20 backdrop-blur-sm px-6 sm:px-8 py-5 sm:py-6 h-auto rounded-lg relative overflow-hidden group" variant="outline">
            ...
            <div className="relative w-full max-w-lg mx-auto">
              ...
              transformStyle: "preserve-3d"
                ...
                <div className="bg-white/10 backdrop-blur-lg rounded-2xl p-4 sm:p-6 border border-white/20 shadow-[0_20px_80px_-10px_rgba(45,212,191,0.3)] transform transition-all duration-200 relative overflow-hidden">
                  ...
                  <div className="bg-[#1E1E2E]/70 backdrop-blur-md rounded-xl p-3 sm:p-4 mb-4 sm:mb-5 relative" style={{
                  transformStyle: 'preserve-3d'
                }}>
                    {/* Inner noise texture */}
                    ...
                    <div className="grid grid-cols-2 gap-2 sm:gap-3">
                      ...
                      <motion.div className="bg-teal-500/20 backdrop-blur-md rounded-lg p-2 sm:p-3 flex items-center relative z-10 overflow-hidden group" whileHover={{
                      scale: 1.03,
                      y: -2,
                      ...
                      transformStyle: "preserve-3d"
                        ...
                        <Palette className="h-4 w-4 sm:h-5 sm:w-5 text-teal-400 mr-1.5 sm:mr-2 relative" style={{
